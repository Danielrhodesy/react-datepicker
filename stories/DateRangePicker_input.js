...
storiesOf('DRP - Input Props', module)
  .add('default', withInfo()(() => (
    <DateRangePickerWrapper
      initialwidget_date={moment().add(3, 'months')}
      initialwidget_date_to={moment().add(3, 'months').add(10, 'days')}
    />
  )))
  ...
  .add('with clear dates button', withInfo()(() => (
    <DateRangePickerWrapper
      initialwidget_date={moment().add(3, 'days')}
      initialwidget_date_to={moment().add(10, 'days')}
      showClearDates
    />
  )))
  ...
  .add('with custom Start & End Date title attributes', withInfo()(() => (
    <DateRangePickerWrapper
      initialwidget_date={moment().add(3, 'days')}
      initialwidget_date_to={moment().add(10, 'days')}
      widget_dateTitleText="Here you can set the title attribute of the Start input, which shows in the tooltip on :hover over the field"
      widget_date_toTitleText="Here you can set the title attribute of the End input, which shows in the tooltip on :hover over the field"
    />
  )))
